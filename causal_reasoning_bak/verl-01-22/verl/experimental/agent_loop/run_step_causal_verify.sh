...
# ========================= project paths =========================
cd /local/scratch/zqin30/projects/repo/verl-agent-loop/verl/verl/experimental/agent_loop
...
TRAIN_PARQUET=${TRAIN_PARQUET:-/local/scratch/zqin30/projects/data/math/causal_output/pns_agentloop.parquet}
VAL_PARQUET=${VAL_PARQUET:-$TRAIN_PARQUET}

# Prefer local model path if exists, else HF hub path.
MODEL_PATH=${MODEL_PATH:-/local/scratch/zqin30/models/Qwen/Qwen2.5-7B-Instruct}
...
python3 -m verl.trainer.main_ppo \
  ...
  actor_rollout_ref.rollout.agent.agent_loop_config_path=/local/scratch/zqin30/projects/repo/verl-agent-loop/verl/verl/experimental/agent_loop/step_causal_verifier.yaml \
