...
RUN_LOG_DIR="/home/projects/hku-medai/larrypl/code/mq/causal-reasoning/verl-01-22/run_log"
RUN_LOG_TS="$(date '+%Y-%m-%d-%H')"
RUN_LOG="${RUN_LOG_DIR}/run_${RUN_LOG_TS}.log.txt"

# Mirror all stdout/stderr to run.log.txt
mkdir -p "$RUN_LOG_DIR"
